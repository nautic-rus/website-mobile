    ...
    switch (this.lang){
      case 'EN': {
        switch (value){
          ...
          case 'Нажмите для загрузки файла': return 'Click to download the file';
          case '': return '';
          case '': return '';
          case '': return '';
